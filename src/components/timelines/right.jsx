            ...
            <div className="content-wrapper">
                <div className="content-header row">
                    <div className="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                        <h3 className="content-header-title mb-0 d-inline-block">Timeline Right</h3>
                        <div className="row breadcrumbs-top d-inline-block">
                            <div className="breadcrumb-wrapper col-12">
                                <ol className="breadcrumb">
                                    ...
                                    <li className="breadcrumb-item active">Timeline Right
                                    </li>
                                </ol>
                            </div>
                        </div>
                ...
                <div className="content-body">
                    <section id="timeline" className="timeline-right timeline-wrapper">
                        <h3 className="page-title text-center text-lg-right">Timeline</h3>
                        <ul className="timeline">
                            <li className="timeline-line" />
                            <li className="timeline-group">
                                <a href="#" className="btn btn-primary"><i className="la la-calendar" /> Today</a>
                            </li>
                        </ul>
                        <ul className="timeline">
                            <li className="timeline-line" />
                            <li className="timeline-item">
                                <div className="timeline-badge">
                                    <span className="bg-red bg-lighten-1" data-toggle="tooltip" data-placement="left" title="Portfolio project work"><i className="la la-plane" /></span>
                                </div>
                            ...
                            <li className="timeline-item">
                                <div className="timeline-badge">
                                    <span className="bg-red bg-lighten-1" data-toggle="tooltip" data-placement="left" title="Portfolio project work"><i className="la la-plus-square-o" /></span>
                                </div>
                                <div className="timeline-card card border-grey border-lighten-2">
                                    <div className="card-header">
                            ...
                            <li className="timeline-item">
                                <div className="timeline-badge">
                                    <span className="bg-success bg-lighten-1" data-toggle="tooltip" data-placement="left" title="Portfolio project work"><i className="la la-bar-chart-o" /></span>
                                </div>
                                <div className="timeline-card card border-grey border-lighten-2">
                                    <div className="card-header">
                        ...
                        <ul className="timeline">
                            <li className="timeline-line" />
                            <li className="timeline-group">
                                <a href="#" className="btn btn-primary"><i className="la la-calendar" /> 2016</a>
                            </li>
                        </ul>
                        <ul className="timeline">
                            <li className="timeline-line" />
                        ...
                        <ul className="timeline">
                            <li className="timeline-line" />
                            <li className="timeline-group">
                                <a href="#" className="btn btn-primary"><i className="la la-calendar" /> 2015</a>
                            </li>
                        </ul>
                        <ul className="timeline">
                            <li className="timeline-line" />
                            ...
                            <li className="timeline-item">
                                <div className="timeline-badge">
                                    <span className="bg-success bg-lighten-1" data-toggle="tooltip" data-placement="left" title="Portfolio project work"><i className="la la-image" /></span>
                                </div>
                                <div className="timeline-card card border-grey border-lighten-2">
                                    <div className="card-header">
                                        <div className="text-center pt-1">
               ...
               It's a separate element as animating opacity is faster than rgba(). */}
                  ...
                  Don't modify these 3 pswp__item elements, data is added later on. */}
                        ...
                        <ul className="timeline">
                            <li className="timeline-line" />
                            <li className="timeline-group">
                                <a href="#" className="btn btn-primary"><i className="la la-calendar" /> 2014</a>
                            </li>
                        </ul>
                        <ul className="timeline">
                            <li className="timeline-line" />
                            ...
                            <li className="timeline-item">
                                <div className="timeline-badge">
                                    <span className="bg-primary bg-lighten-1" data-toggle="tooltip" data-placement="left" title="Moved to Brooklyn"><i className="la la-map" /></span>
                                </div>
                                <div className="timeline-card card border-grey border-lighten-2">
                                    <div className="card-header ">
                                        <div className="text-center pt-1">
                        ...
                        <ul className="timeline">
                            <li className="timeline-line" />
                            <li className="timeline-group">
                                <a href="#" className="btn btn-primary"><i className="la la-calendar" /> Founded in 2012</a>
                            </li>
                        </ul>
                    </section>
                </div>
